    ...
    def test_duplicate_upsert_does_not_create_product(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                ...
                conn.execute("CREATE TABLE products (id INTEGER PRIMARY KEY, name TEXT, slug TEXT UNIQUE, brand TEXT, ingredients TEXT, url TEXT, image_url TEXT, category TEXT, saved_at TEXT)")
                conn.commit()
                conn.close()
