...
ЕСЛИ ты не знаешь состав продукта, ЕСЛИ введён бренд вместо продукта, ЕСЛИ введено что-то не косметическое (например, "помидор") — 
ТЫ ОБЯЗАН написать в summary ровно: "НЕИЗВЕСТНЫЙ СОСТАВ"

НИКАКИХ ДРУГИХ ФРАЗ. ТОЛЬКО ЭТА.
...
{{
  ...
  "summary": "ТВОЙ ВЫВОД. ЕСЛИ НЕ ЗНАЕШЬ СОСТАВ, БРЕНД ИЛИ НЕ КОСМЕТИКА — НАПИШИ РОВНО: НЕИЗВЕСТНЫЙ СОСТАВ",
  "safe_ingredients": [],
  "caution_ingredients": []
}}

ЕЩЁ РАЗ: ЕСЛИ НЕ ЗНАЕШЬ СОСТАВ — ПИШИ ТОЛЬКО "НЕИЗВЕСТНЫЙ СОСТАВ". НИКАКИХ ДРУГИХ ФРАЗ.
"""
