...
- ЕСЛИ ты не знаешь состав продукта — напиши в summary ровно: "НЕИЗВЕСТНЫЙ СОСТАВ" и поставь score=50.
- В остальных случаях — давай честную оценку по шкале 0–100 на основе своих знаний.
