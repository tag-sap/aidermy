...
ЕСЛИ ты не знаешь состав продукта — 
ТЫ ОБЯЗАН:
...
{{
  ...
  "summary": "Краткое пояснение на русском. Если не знаешь состав — напиши ровно: НЕИЗВЕСТНЫЙ СОСТАВ",
  "safe_ingredients": [],
  "caution_ingredients": []
}}

Ещё раз: если не знаешь состав — напиши только "НЕИЗВЕСТНЫЙ СОСТАВ" в summary, score = 0, verdict = "Неизвестный состав".
"""
