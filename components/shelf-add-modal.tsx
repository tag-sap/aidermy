...
export function ShelfAddModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/30 p-4 backdrop-blur-sm animate-modal-backdrop" onClick={onClose}>
      <div className="flex max-h-[80dvh] w-full max-w-md max-w-[100vw] flex-col overflow-hidden rounded-2xl border border-white/50 bg-white/75 p-4 backdrop-blur-xl animate-modal-panel" onClick={(e) => e.stopPropagation()}>
