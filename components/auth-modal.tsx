        ...
        {mode !== 'success' && (
          <>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white py-2.5 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-50"
            >
